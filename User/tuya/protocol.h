...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define COMMON_WARDROBE


#ifdef SOCKS_DRAWER
	#define PRODUCT_KEY "j4cokv8zy9nsewtt"			//智能袜屉
#endif
#ifdef UNDERWEAR_DRAWER
	#define PRODUCT_KEY "nnbsjwmijkqh9juy"			//智能内衣屉
#endif
#ifdef SMALL_WARDROBE
	#define PRODUCT_KEY "hjaq0ubsqa5lpssj"			//小衣柜
#endif
#ifdef BIG_WARDROBE
	#define PRODUCT_KEY "g8wz5xfhxqtxofkr"			//大衣柜
#endif
#ifdef COMMON_WARDROBE
	#define PRODUCT_KEY "mzlpxdz7bifp8d91"			//衣物护理机
#endif
#ifdef TEST
	#define PRODUCT_KEY "v604zhy3d3if2neh"			//测试
#endif
...
//#define PRODUCT_KEY "mzlpxdz7bifp8d91"    //开发平台创建产品后生成的16位字符产品唯一标识
